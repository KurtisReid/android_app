...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || SocialPreferenceFragment.class.getName().equals(fragmentName)
    ...
    /*
    This fragment is for the social networks prefences
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class SocialPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_social_net);
            setHasOptionsMenu(true);
